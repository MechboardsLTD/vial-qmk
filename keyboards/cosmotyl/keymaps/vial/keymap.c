...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     [0] = LAYOUT(
               ...
               KC_TAB,        KC_Q,          KC_W,          KC_E,           KC_R,           KC_T,                                     KC_Y,         KC_U,          KC_I,           KC_O,        KC_P,       KC_PRINT_SCREEN, 
               LCTL_T(KC_ESC),KC_A,          KC_S,          KC_D,           KC_F,           KC_G,                                     KC_H,         KC_J,          KC_K,           KC_L,        KC_SCLN,    KC_QUOT, 
               SC_LSPO,       KC_Z,          KC_X,          KC_C,           KC_V,           KC_B,                                     KC_N,         KC_M,          KC_COMM,        KC_DOT,      KC_SLSH,    SC_RSPC, 
                                             KC_LGUI,       KC_LALT,                                                                                               LALT_T(KC_RALT),KC_RGUI, 
                                                            TT(2),          LT(6, KC_SPC),  LT(4, KC_DEL),                           LT(4, KC_ENT), KC_SPC,        LT(2, KC_BSPC), 
                                                                            KC_LBRC,        LCTL_T(KC_LBRC),                         LT(4, KC_ENT), KC_RBRC
          ),
     [1] = LAYOUT(
               KC_GRV,        KC_1,          KC_2,          KC_3,          KC_4,             KC_5,                                     KC_6,         KC_7,          KC_8,           KC_9,        KC_0,       KC_MINS, 
               KC_TAB,        KC_Q,          KC_W,          KC_F,          KC_P,             KC_G,                                     KC_J,         KC_L,          KC_U,           KC_Y,        KC_SCLN,    KC_PRINT_SCREEN, 
     ...
     [2] = LAYOUT(
               QK_BOOT,       KC_PWR,        KC_TRNS,       KC_TRNS,       KC_TRNS,           KC_TRNS,                                 KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,      KC_PWR,     QK_BOOT, 
               KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,           KC_TRNS,                                 KC_7,          KC_7,          KC_8,          KC_9,         KC_TRNS,    KC_PRINT_SCREEN, 
               ...
               KC_TRNS,       MO(5),         KC_NO,         KC_NO,         KC_NO,             KC_NO,                                   KC_1,          KC_1,          KC_2,          KC_3,         KC_BSLS,    KC_TRNS, 
                                             KC_TRNS,       KC_TRNS,                                                                                                 KC_TRNS,       KC_TRNS, 
                                                            KC_TRNS,       KC_SPC,            KC_DEL,                                  KC_ENT,        KC_0,          KC_BSPC, 
                                                                           TG(2),             KC_TRNS,                                 KC_ENT,        KC_TRNS
          ),
     [3] = LAYOUT(
               KC_TRNS,       KC_F1,         KC_F2,         KC_F3,         KC_F4,              KC_F5,                                  KC_F6,         KC_F7,         KC_F8,         KC_F9,         KC_F10,     KC_F11, 
               KC_TRNS,       KC_NO,         KC_NO,         KC_NO,         KC_NO,              KC_NO,                                  KC_F7,         KC_F7,         KC_F8,         KC_F9,         KC_F10,     KC_NO, 
               ...
               KC_TRNS,       KC_NO,         KC_NO,         KC_NO,         KC_NO,              KC_NO,                                  KC_F1,         KC_F1,         KC_F2,         KC_F3,         KC_F12,     KC_TRNS, 
                                             KC_TRNS,       KC_TRNS,                                                                                                 KC_TRNS,       KC_TRNS, 
                                                            KC_TRNS,       KC_SPC,             KC_DEL,                                 KC_ENT,       KC_SPC,         KC_BSPC,
                                                                           TG(3),              KC_TRNS,                                KC_ENT,       KC_TRNS
          ),
     [4] = LAYOUT(
